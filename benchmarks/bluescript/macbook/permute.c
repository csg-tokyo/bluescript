...
static void fbody_swap(value_t _v, int32_t _i, int32_t _j) {
  ...
  func_rootset.values[0] = _v;
  {
    ...
    (*gc_array_get(func_rootset.values[0], _i)) = (*gc_array_get(func_rootset.values[0], _j));
    (*gc_array_get(func_rootset.values[0], _j)) = func_rootset.values[1];
  }
  DELETE_ROOT_SET(func_rootset)
}
struct _swap _swap = { fbody_swap, "([aii)v" };

static void fbody_permute(int32_t _n, value_t _v) {
  ROOT_SET(func_rootset, 2)
  func_rootset.values[0] = _v;
  {
    _count+=1;
    if (_n != 0) {
      int32_t _n1 = _n - 1;
      _permute.fptr(_n1, func_rootset.values[1]=func_rootset.values[0]);
      for (
      int32_t _i = _n1;_i > -1; _i--) {
        _swap.fptr(func_rootset.values[1]=func_rootset.values[0], _n1, _i);
        _permute.fptr(_n1, func_rootset.values[1]=func_rootset.values[0]);
        _swap.fptr(func_rootset.values[1]=func_rootset.values[0], _n1, _i);
      }
    }
...
struct _permute _permute = { fbody_permute, "(i[a)v" };
...
void bluescript_main2() {
  ...
  _RESULT = 8660;
  _count = 0;
  global_rootset2.values[0] = _newArray.fptr(6, func_rootset.values[0]=int_to_value(0));
  _permute.fptr(6, func_rootset.values[0]=global_rootset2.values[0]);
