    ...
    while (n2 > 0) {
        ...
        while (j < ie) {
            ...
            for (int i = 0; i < n2; i++) {
                ...
                SC16 m1 = {0, 0};
                int result = a_data.re * MULT_SHIFT;
...
void benchmark_main() {
    // int inout_data[DATA_LEN];
    int *inout_data = calloc(DATA_LEN, sizeof(int));
