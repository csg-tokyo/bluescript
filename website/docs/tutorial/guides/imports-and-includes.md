...
BlueScript and C source files must be placed under the `srcDir` directory configured in [bsconfig.json](/docs/reference/bsconfig). Relative import paths must resolve to files inside `srcDir`.
