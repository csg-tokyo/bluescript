...
const featureItems: FeatureItem[] = [
  ...
  },
  {
    ...
    description: 'Performance that matters. BlueScript compiles directly to native code, delivering exceptional performance. This means blazing-fast execution—up to 20x faster than MicroPython on average. With no VM and no unnecessary libraries, your applications stay small and lean, perfect for resource-constrained devices.\n[1] S. Marr, DLS’16',
    imageUrl: '/img/execution-time.png',
  },
  {
    title: 'Untethered Wireless Workflow',
    description: 'BlueScript allows you to update and restart your programs wirelessly over Bluetooth. Stop fumbling with short, cumbersome USB cables. Flash your device and see your changes instantly from across the room.',
