...
BlueScript is a subset of TypeScript because, for example, it (*currently*) does not support exceptions,
promises, async/await, or certain built-in objects.
...
it always holds a native integer-value during runtime
