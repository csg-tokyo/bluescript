...
static esp_gatt_char_prop_t shell_property = 0;
...
static struct gatts_profile_inst gl_profile_tab[PROFILE_NUM] = {
    [PROFILE_SHELL_APP_ID] = {
        .gatts_cb = gatts_profile_shell_event_handler,
...
static void gatts_profile_shell_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_REG_EVT:
        ...
        gl_profile_tab[PROFILE_SHELL_APP_ID].service_id.is_primary = true;
        gl_profile_tab[PROFILE_SHELL_APP_ID].service_id.id.inst_id = 0x00;
        ...
        adv_config_done |= scan_rsp_config_flag;
        esp_ble_gatts_create_service(gatts_if, &gl_profile_tab[PROFILE_SHELL_APP_ID].service_id, GATTS_NUM_HANDLE_SHELL);
        break;
    ...
    case ESP_GATTS_CREATE_EVT:
        ...
        gl_profile_tab[PROFILE_SHELL_APP_ID].service_handle = param->create.service_handle;
        gl_profile_tab[PROFILE_SHELL_APP_ID].char_uuid.len = ESP_UUID_LEN_16;
        gl_profile_tab[PROFILE_SHELL_APP_ID].char_uuid.uuid.uuid16 = GATTS_CHAR_UUID_SHELL;

        esp_ble_gatts_start_service(gl_profile_tab[PROFILE_SHELL_APP_ID].service_handle);
        shell_property = ESP_GATT_CHAR_PROP_BIT_READ | ESP_GATT_CHAR_PROP_BIT_WRITE | ESP_GATT_CHAR_PROP_BIT_NOTIFY;
        esp_err_t add_char_ret = esp_ble_gatts_add_char(gl_profile_tab[PROFILE_SHELL_APP_ID].service_handle, &gl_profile_tab[PROFILE_SHELL_APP_ID].char_uuid,
    ...
    case ESP_GATTS_ADD_CHAR_EVT: {
        ...
        gl_profile_tab[PROFILE_SHELL_APP_ID].char_handle = param->add_char.attr_handle;
        gl_profile_tab[PROFILE_SHELL_APP_ID].descr_uuid.len = ESP_UUID_LEN_16;
        gl_profile_tab[PROFILE_SHELL_APP_ID].descr_uuid.uuid.uuid16 = ESP_GATT_UUID_CHAR_CLIENT_CONFIG;
        ...
        esp_err_t add_descr_ret = esp_ble_gatts_add_char_descr(gl_profile_tab[PROFILE_SHELL_APP_ID].service_handle, &gl_profile_tab[PROFILE_SHELL_APP_ID].descr_uuid,
    ...
    case ESP_GATTS_ADD_CHAR_DESCR_EVT:
        ...
        gl_profile_tab[PROFILE_SHELL_APP_ID].descr_handle = param->add_char_descr.attr_handle;
...
static void write_action_handler(uint8_t *value, int value_len) {
    ...
    bs_shell_set_tasks(value, value_len);
...
void bs_ble_init(void)
{
    ...
    ret = esp_ble_gatts_app_register(PROFILE_SHELL_APP_ID);
    if (ret){
